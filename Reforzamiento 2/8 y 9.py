...
newlist = []
newlist.append("Economia")
newlist.append(2)
newlist.append(10.2)
newlist.append("Ingenieria")
newlist.append(8.7)
newlist.append(15.9)
newlist.append(1000)
newlist.append("Finanzas")
newlist.append(510)
print("{}".format(newlist))

suma_listas = newlist + lista_cursos
print("Las listas sumadas dan: {}".format(suma_listas))